...
const VARIABLE_CATALOG: Record<string, VariableDef[]> = {
	...
	'experiment-lookup': [
		...
		{ name: 'experiment.movies', description: 'List of movies watched', source: 'BadMovies DB' },
		{ name: 'experiment.host', description: 'The host of the experiment', source: 'BadMovies DB' },
		{ name: 'experiment.url', description: 'Link to experiment details', source: 'BadMovies DB' },
		{ name: 'experiment.imageUrl', description: 'Thumbnail for the experiment', source: 'BadMovies DB' },
	...
	quote: [
		...
		{ name: 'quote.movie', description: 'Movie title the quote is from', source: 'BadMovies DB' },
