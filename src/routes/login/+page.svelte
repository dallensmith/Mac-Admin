...
>
	...
	<div class="absolute inset-0 z-0">
		<div
			class="absolute -top-40 -left-40 h-96 w-96 animate-pulse rounded-full bg-cyan-600/20 blur-[100px]"
		></div>
		<div
			class="absolute right-0 bottom-0 h-[30rem] w-[30rem] translate-x-1/3 translate-y-1/3 rounded-full bg-purple-600/20 blur-[120px]"
		></div>
	</div>

	<div class="relative z-10 w-full max-w-md">
		<div
			class="group relative overflow-hidden rounded-2xl border border-cyan-500/30 bg-slate-900/80 p-8 shadow-[0_0_50px_rgba(34,211,238,0.1)] backdrop-blur-xl"
		>
			<div
			...
			<div class="relative z-10 mb-8 text-center">
				<div
					class="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-xl border border-cyan-500/50 bg-cyan-500/10 shadow-[0_0_15px_rgba(34,211,238,0.5)]"
				>
					<svg
						...
						class="lucide lucide-bot text-cyan-400 drop-shadow-[0_0_5px_rgba(34,211,238,0.8)]"
				...
				<h1
					class="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-3xl font-black tracking-widest text-transparent uppercase drop-shadow-[0_0_10px_rgba(168,85,247,0.4)]"
				>
					MAC.ADMIN
				</h1>
